...
- Current section lists to keep in sync:
  ...
  - **Another Way to Count** (7): `quipus`, `practicing_with_quipus`, `mesoamerican_symbols`, `overcoming_limits`, `building_like_a_mesoamerican`, `mesoamerican_orders`, `text_or_number`
...
- Current list (latest first): `text_or_number` (Text or Number), `mesoamerican_orders` (Mesoamerican Orders), `building_like_a_mesoamerican` (Building Like a Mesoamerican), `overcoming_limits` (Overcoming Limits), `mesoamerican_symbols` (The Mesoamerican Symbols).
