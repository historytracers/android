...
import com.historytracers.app.ui.screens.AbacusInRereadingScreen
                ...
                NavHost(
                    ...
                    composable(Screen.Abacus.route) {
                        AbacusScreen(
                            ...
                            onNavigateToAbacusInRereading = { navController.navigate(Screen.AbacusInRereading.route) },
                    ...
                    composable(Screen.AbacusInRereading.route) {
                        AbacusInRereadingScreen(
                            onNavigateBack = {
                                if (!navController.popBackStack(Screen.Abacus.route, false)) {
                                    navController.navigate(Screen.Abacus.route) {
                                        popUpTo(0) { inclusive = true }
