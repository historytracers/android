...
data class AddingSameNumbersScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnAddingSameNumbersScreenStrings = AddingSameNumbersScreenStrings(
    title = "Adding the Same Numbers",
...
val PtAddingSameNumbersScreenStrings = AddingSameNumbersScreenStrings(
    title = "Somando o mesmo n\u00famero",
...
val EsAddingSameNumbersScreenStrings = AddingSameNumbersScreenStrings(
    title = "Sumando los mismos n\u00fameros",
...
val LocalAddingSameNumbersScreenStrings = staticCompositionLocalOf { EnAddingSameNumbersScreenStrings }

fun addingSameNumbersScreenStringsForLanguage(language: String): AddingSameNumbersScreenStrings = when (language) {
    "pt-BR" -> PtAddingSameNumbersScreenStrings
    "es-ES" -> EsAddingSameNumbersScreenStrings
    else -> EnAddingSameNumbersScreenStrings
}
