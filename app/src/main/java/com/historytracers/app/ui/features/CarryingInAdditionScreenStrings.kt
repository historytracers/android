...
data class CarryingInAdditionScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnCarryingInAdditionScreenStrings = CarryingInAdditionScreenStrings(
...
val PtCarryingInAdditionScreenStrings = CarryingInAdditionScreenStrings(
    title = "O Vai-Um na Adi\u00e7\u00e3o",
...
val EsCarryingInAdditionScreenStrings = CarryingInAdditionScreenStrings(
    title = "El Llevar en la Adici\u00f3n",
...
val LocalCarryingInAdditionScreenStrings = staticCompositionLocalOf { EnCarryingInAdditionScreenStrings }

fun carryingInAdditionScreenStringsForLanguage(language: String): CarryingInAdditionScreenStrings = when (language) {
    "pt-BR" -> PtCarryingInAdditionScreenStrings
    "es-ES" -> EsCarryingInAdditionScreenStrings
    else -> EnCarryingInAdditionScreenStrings
}
