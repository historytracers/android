...
data class DrawingAndCoutingScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnDrawingAndCoutingScreenStrings = DrawingAndCoutingScreenStrings(
    title = "Drawing and Couting",
...
val PtDrawingAndCoutingScreenStrings = DrawingAndCoutingScreenStrings(
    title = "Desenho e Contagem",
...
val EsDrawingAndCoutingScreenStrings = DrawingAndCoutingScreenStrings(
    title = "Dibujo y Conteo",
...
val LocalDrawingAndCoutingScreenStrings = staticCompositionLocalOf { EnDrawingAndCoutingScreenStrings }

fun drawingAndCoutingScreenStringsForLanguage(language: String): DrawingAndCoutingScreenStrings = when (language) {
    "pt-BR" -> PtDrawingAndCoutingScreenStrings
    "es-ES" -> EsDrawingAndCoutingScreenStrings
    else -> EnDrawingAndCoutingScreenStrings
}
