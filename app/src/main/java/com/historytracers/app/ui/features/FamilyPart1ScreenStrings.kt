...
data class FamilyPart1ScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnFamilyPart1ScreenStrings = FamilyPart1ScreenStrings(
    title = "Family (Part 1)",
...
val PtFamilyPart1ScreenStrings = FamilyPart1ScreenStrings(
    title = "Fam\u00edlia (Parte 1)",
...
val EsFamilyPart1ScreenStrings = FamilyPart1ScreenStrings(
    title = "Familia (Parte 1)",
...
val LocalFamilyPart1ScreenStrings = staticCompositionLocalOf { EnFamilyPart1ScreenStrings }

fun familyPart1ScreenStringsForLanguage(language: String): FamilyPart1ScreenStrings = when (language) {
    "pt-BR" -> PtFamilyPart1ScreenStrings
    "es-ES" -> EsFamilyPart1ScreenStrings
    else -> EnFamilyPart1ScreenStrings
}
