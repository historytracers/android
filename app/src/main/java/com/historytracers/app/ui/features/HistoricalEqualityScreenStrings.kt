...
data class HistoricalEqualityScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnHistoricalEqualityScreenStrings = HistoricalEqualityScreenStrings(
    title = "Historical Equality",
...
val PtHistoricalEqualityScreenStrings = HistoricalEqualityScreenStrings(
    title = "Igualdade Hist\u00f3rica",
...
val EsHistoricalEqualityScreenStrings = HistoricalEqualityScreenStrings(
    title = "Igualdad Hist\u00f3rica",
...
val LocalHistoricalEqualityScreenStrings = staticCompositionLocalOf { EnHistoricalEqualityScreenStrings }

fun historicalEqualityScreenStringsForLanguage(language: String): HistoricalEqualityScreenStrings = when (language) {
    "pt-BR" -> PtHistoricalEqualityScreenStrings
    "es-ES" -> EsHistoricalEqualityScreenStrings
    else -> EnHistoricalEqualityScreenStrings
}
