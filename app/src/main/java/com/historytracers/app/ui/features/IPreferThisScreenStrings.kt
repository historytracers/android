...
data class IPreferThisScreenStrings(
    val title: String,
...
val EnIPreferThisScreenStrings = IPreferThisScreenStrings(
    title = "I Prefer This",
...
val PtIPreferThisScreenStrings = IPreferThisScreenStrings(
    title = "Eu Prefiro Este",
...
val EsIPreferThisScreenStrings = IPreferThisScreenStrings(
    title = "Yo Prefiero Este",
    etruscanRoman = "Etrusco-Romano",
...
val LocalIPreferThisScreenStrings = staticCompositionLocalOf { EnIPreferThisScreenStrings }

fun iPreferThisScreenStringsForLanguage(language: String): IPreferThisScreenStrings = when (language) {
    "pt-BR" -> PtIPreferThisScreenStrings
    "es-ES" -> EsIPreferThisScreenStrings
    else -> EnIPreferThisScreenStrings
}
