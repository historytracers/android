...
data class InversionScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnInversionScreenStrings = InversionScreenStrings(
    title = "Inversion",
...
val PtInversionScreenStrings = InversionScreenStrings(
    title = "Invers\u00e3o",
...
val EsInversionScreenStrings = InversionScreenStrings(
    title = "Inversi\u00f3n",
...
val LocalInversionScreenStrings = staticCompositionLocalOf { EnInversionScreenStrings }

fun inversionScreenStringsForLanguage(language: String): InversionScreenStrings = when (language) {
    "pt-BR" -> PtInversionScreenStrings
    "es-ES" -> EsInversionScreenStrings
    else -> EnInversionScreenStrings
}
