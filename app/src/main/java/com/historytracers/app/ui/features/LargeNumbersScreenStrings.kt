...
data class LargeNumbersScreenStrings(
    val title: String,
    val tens: String,
    val units: String,
    val number: String,
...
val EnLargeNumbersScreenStrings = LargeNumbersScreenStrings(
    title = "Large Numbers",
    tens = "Tens",
    units = "Units",
    number = "Number",
...
val PtLargeNumbersScreenStrings = LargeNumbersScreenStrings(
...
val EsLargeNumbersScreenStrings = LargeNumbersScreenStrings(
    title = "N\u00fameros Grandes",
    tens = "Decenas",
    units = "Unidades",
    number = "N\u00famero",
...
val LocalLargeNumbersScreenStrings = staticCompositionLocalOf { EnLargeNumbersScreenStrings }

fun largeNumbersScreenStringsForLanguage(language: String): LargeNumbersScreenStrings = when (language) {
    "pt-BR" -> PtLargeNumbersScreenStrings
    "es-ES" -> EsLargeNumbersScreenStrings
    else -> EnLargeNumbersScreenStrings
}
