...
data class LimitsMinMaxScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnLimitsMinMaxScreenStrings = LimitsMinMaxScreenStrings(
    title = "Limits (Min and Max)",
...
val PtLimitsMinMaxScreenStrings = LimitsMinMaxScreenStrings(
    title = "Limites (min e max)",
...
val EsLimitsMinMaxScreenStrings = LimitsMinMaxScreenStrings(
    title = "L\u00edmites (m\u00edn y m\u00e1x)",
...
val LocalLimitsMinMaxScreenStrings = staticCompositionLocalOf { EnLimitsMinMaxScreenStrings }

fun limitsMinMaxScreenStringsForLanguage(language: String): LimitsMinMaxScreenStrings = when (language) {
    "pt-BR" -> PtLimitsMinMaxScreenStrings
    "es-ES" -> EsLimitsMinMaxScreenStrings
    else -> EnLimitsMinMaxScreenStrings
}
