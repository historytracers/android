...
data class MatterAndEnergyScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnMatterAndEnergyScreenStrings = MatterAndEnergyScreenStrings(
...
val PtMatterAndEnergyScreenStrings = MatterAndEnergyScreenStrings(
...
val EsMatterAndEnergyScreenStrings = MatterAndEnergyScreenStrings(
...
val LocalMatterAndEnergyScreenStrings = staticCompositionLocalOf { EnMatterAndEnergyScreenStrings }

fun matterAndEnergyScreenStringsForLanguage(language: String): MatterAndEnergyScreenStrings = when (language) {
    "pt-BR" -> PtMatterAndEnergyScreenStrings
    "es-ES" -> EsMatterAndEnergyScreenStrings
    else -> EnMatterAndEnergyScreenStrings
}
