...
data class MesoamericanSymbolsScreenStrings(
    val title: String,
...
val EnMesoamericanSymbolsScreenStrings = MesoamericanSymbolsScreenStrings(
    title = "The Mesoamerican Symbols",
    mayaLabel = "Maya",
...
val PtMesoamericanSymbolsScreenStrings = MesoamericanSymbolsScreenStrings(
    title = "Os S\u00edmbolos Mesoamericanos",
    mayaLabel = "Maia",
...
val EsMesoamericanSymbolsScreenStrings = MesoamericanSymbolsScreenStrings(
    title = "Los S\u00edmbolos Mesoamericanos",
    mayaLabel = "Maya",
...
val LocalMesoamericanSymbolsScreenStrings = staticCompositionLocalOf { EnMesoamericanSymbolsScreenStrings }

fun mesoamericanSymbolsScreenStringsForLanguage(language: String): MesoamericanSymbolsScreenStrings = when (language) {
    "pt-BR" -> PtMesoamericanSymbolsScreenStrings
    "es-ES" -> EsMesoamericanSymbolsScreenStrings
    else -> EnMesoamericanSymbolsScreenStrings
}
