...
data class MultiplyingWithYupanaScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnMultiplyingWithYupanaScreenStrings = MultiplyingWithYupanaScreenStrings(
    title = "Multiplying with Yupana",
...
val PtMultiplyingWithYupanaScreenStrings = MultiplyingWithYupanaScreenStrings(
    title = "Multiplicando com a Yupana",
...
val EsMultiplyingWithYupanaScreenStrings = MultiplyingWithYupanaScreenStrings(
    title = "Multiplicando con la Yupana",
...
val LocalMultiplyingWithYupanaScreenStrings = staticCompositionLocalOf { EnMultiplyingWithYupanaScreenStrings }

fun multiplyingWithYupanaScreenStringsForLanguage(language: String): MultiplyingWithYupanaScreenStrings = when (language) {
    "pt-BR" -> PtMultiplyingWithYupanaScreenStrings
    "es-ES" -> EsMultiplyingWithYupanaScreenStrings
    else -> EnMultiplyingWithYupanaScreenStrings
}
