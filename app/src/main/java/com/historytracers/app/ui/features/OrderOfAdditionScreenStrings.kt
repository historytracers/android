...
data class OrderOfAdditionScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnOrderOfAdditionScreenStrings = OrderOfAdditionScreenStrings(
    title = "The Order of Addition",
...
val PtOrderOfAdditionScreenStrings = OrderOfAdditionScreenStrings(
    title = "A ordem da Adi\u00e7\u00e3o",
...
val EsOrderOfAdditionScreenStrings = OrderOfAdditionScreenStrings(
    title = "El Orden de la Adici\u00f3n",
...
val LocalOrderOfAdditionScreenStrings = staticCompositionLocalOf { EnOrderOfAdditionScreenStrings }

fun orderOfAdditionScreenStringsForLanguage(language: String): OrderOfAdditionScreenStrings = when (language) {
    "pt-BR" -> PtOrderOfAdditionScreenStrings
    "es-ES" -> EsOrderOfAdditionScreenStrings
    else -> EnOrderOfAdditionScreenStrings
}
