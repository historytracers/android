...
data class QuipusScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnQuipusScreenStrings = QuipusScreenStrings(
    title = "Quipus",
...
val PtQuipusScreenStrings = QuipusScreenStrings(
    title = "Quipus",
...
val EsQuipusScreenStrings = QuipusScreenStrings(
    title = "Quipus",
...
val LocalQuipusScreenStrings = staticCompositionLocalOf { EnQuipusScreenStrings }

fun quipusScreenStringsForLanguage(language: String): QuipusScreenStrings = when (language) {
    "pt-BR" -> PtQuipusScreenStrings
    "es-ES" -> EsQuipusScreenStrings
    else -> EnQuipusScreenStrings
}
