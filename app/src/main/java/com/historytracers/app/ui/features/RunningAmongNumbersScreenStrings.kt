...
data class RunningAmongNumbersScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnRunningAmongNumbersScreenStrings = RunningAmongNumbersScreenStrings(
    title = "Running Among Numbers",
...
val PtRunningAmongNumbersScreenStrings = RunningAmongNumbersScreenStrings(
    title = "Correndo entre os n\u00fameros",
...
val EsRunningAmongNumbersScreenStrings = RunningAmongNumbersScreenStrings(
    title = "Corriendo entre n\u00fameros",
...
val LocalRunningAmongNumbersScreenStrings = staticCompositionLocalOf { EnRunningAmongNumbersScreenStrings }

fun runningAmongNumbersScreenStringsForLanguage(language: String): RunningAmongNumbersScreenStrings = when (language) {
    "pt-BR" -> PtRunningAmongNumbersScreenStrings
    "es-ES" -> EsRunningAmongNumbersScreenStrings
    else -> EnRunningAmongNumbersScreenStrings
}
