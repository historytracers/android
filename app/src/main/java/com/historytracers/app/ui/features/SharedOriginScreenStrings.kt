...
data class SharedOriginScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnSharedOriginScreenStrings = SharedOriginScreenStrings(
    title = "Shared Origin",
...
val PtSharedOriginScreenStrings = SharedOriginScreenStrings(
    title = "Origem Compartilhada",
...
val EsSharedOriginScreenStrings = SharedOriginScreenStrings(
    title = "Origen Compartido",
...
val LocalSharedOriginScreenStrings = staticCompositionLocalOf { EnSharedOriginScreenStrings }

fun sharedOriginScreenStringsForLanguage(language: String): SharedOriginScreenStrings = when (language) {
    "pt-BR" -> PtSharedOriginScreenStrings
    "es-ES" -> EsSharedOriginScreenStrings
    else -> EnSharedOriginScreenStrings
}
