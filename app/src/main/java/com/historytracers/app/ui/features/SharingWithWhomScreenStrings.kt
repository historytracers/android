...
data class SharingWithWhomScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnSharingWithWhomScreenStrings = SharingWithWhomScreenStrings(
    title = "Sharing with Whom?",
...
val PtSharingWithWhomScreenStrings = SharingWithWhomScreenStrings(
    title = "Compartilhar com quem?",
...
val EsSharingWithWhomScreenStrings = SharingWithWhomScreenStrings(
    title = "\u00bfCompartir con qui\u00e9n?",
...
val LocalSharingWithWhomScreenStrings = staticCompositionLocalOf { EnSharingWithWhomScreenStrings }

fun sharingWithWhomScreenStringsForLanguage(language: String): SharingWithWhomScreenStrings = when (language) {
    "pt-BR" -> PtSharingWithWhomScreenStrings
    "es-ES" -> EsSharingWithWhomScreenStrings
    else -> EnSharingWithWhomScreenStrings
}
