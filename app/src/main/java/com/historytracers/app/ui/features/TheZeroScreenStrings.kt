...
data class TheZeroScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnTheZeroScreenStrings = TheZeroScreenStrings(
    title = "The Zero",
...
val PtTheZeroScreenStrings = TheZeroScreenStrings(
    title = "O zero",
...
val EsTheZeroScreenStrings = TheZeroScreenStrings(
    title = "El cero",
...
val LocalTheZeroScreenStrings = staticCompositionLocalOf { EnTheZeroScreenStrings }

fun theZeroScreenStringsForLanguage(language: String): TheZeroScreenStrings = when (language) {
    "pt-BR" -> PtTheZeroScreenStrings
    "es-ES" -> EsTheZeroScreenStrings
    else -> EnTheZeroScreenStrings
}
