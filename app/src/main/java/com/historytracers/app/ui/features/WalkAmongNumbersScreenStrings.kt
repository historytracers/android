...
data class WalkAmongNumbersScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnWalkAmongNumbersScreenStrings = WalkAmongNumbersScreenStrings(
    title = "Walking Among Numbers",
...
val PtWalkAmongNumbersScreenStrings = WalkAmongNumbersScreenStrings(
    title = "Andar entre os n\u00fameros",
...
val EsWalkAmongNumbersScreenStrings = WalkAmongNumbersScreenStrings(
    title = "Caminar entre n\u00fameros",
...
val LocalWalkAmongNumbersScreenStrings = staticCompositionLocalOf { EnWalkAmongNumbersScreenStrings }

fun walkAmongNumbersScreenStringsForLanguage(language: String): WalkAmongNumbersScreenStrings = when (language) {
    "pt-BR" -> PtWalkAmongNumbersScreenStrings
    "es-ES" -> EsWalkAmongNumbersScreenStrings
    else -> EnWalkAmongNumbersScreenStrings
}
