...
data class WhereAreTheyScreenStrings(
    val title: String,
    val wrongAnswerMessage: String,
    val scoreDoubledMessage: String,
)

val EnWhereAreTheyScreenStrings = WhereAreTheyScreenStrings(
...
val PtWhereAreTheyScreenStrings = WhereAreTheyScreenStrings(
    title = "Onde eles est\u00e3o?",
...
val EsWhereAreTheyScreenStrings = WhereAreTheyScreenStrings(
    title = "\u00bfD\u00f3nde est\u00e1n?",
...
val LocalWhereAreTheyScreenStrings = staticCompositionLocalOf { EnWhereAreTheyScreenStrings }

fun whereAreTheyScreenStringsForLanguage(language: String): WhereAreTheyScreenStrings = when (language) {
    "pt-BR" -> PtWhereAreTheyScreenStrings
    "es-ES" -> EsWhereAreTheyScreenStrings
    else -> EnWhereAreTheyScreenStrings
}
